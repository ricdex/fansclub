    ...
    <b-row>
        <b-col cols="6"  class="col-first">
            ...
            <p>
                ...
                Y esta filosofía va más allá de compensaciones y beneficios económicos que podemos generarle a tu club. La llevamos tatuada en la piel y la reflejamos en nuestros valores. 
            </p>
        </b-col>
        <b-col cols="6" >
            <img src="~/assets/images/nosotros.png" alt="logo-fanclub" class="logo" width="100%" height="100%" />
        </b-col>
    </b-row>
  </div>
</template>
